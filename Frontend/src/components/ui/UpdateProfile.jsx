...
const UpdateProfile = () => {
  ...
  const handleSumbitText = (e) => {
    ...
    if (age != "" && weight != "" && height != "") {
      axios
        .patch("/user/updateAccountDetailsTextBased", { age, weight, height })
        .then((res) => {
  ...
  if (allergies != "") {
    axios
      .patch("/user/acceptAllergiesAndMedicalCondition", { allergies })
      .then((res) => {
        console.log(res.data);
      })
      .catch((err) => {
  ...
  if (expectedDate != "") {
    ...
    axios
      .patch("/user/acceptExpectedDate", { expectedDate })
      .then((res) => {
        console.log(res.data);
      })
      .catch((err) => {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen flex justify-center items-center bg-[url('/bg.avif')] bg-cover bg-center bg-no-repeat">
        <div className=" max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden mt-5 flex justify-center">
          <div className="w-1/3 bg-blue-200 flex flex-col items-center py-5 border-r-2 border-blue-600">
            ...
            />
            <form
              onSubmit={handleSumbitAvatar}
              className="flex flex-col mt-5 ml-5 mr-5"
            >
              <input
                type="file"
                name="avatar"
          ...
          <div className="w-2/3 p-6">
            ...
            >
              <div>
                ...
                <input
                  type="number"
                  className="hover:shadow-xl hover:shadow-slate-200 w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300"
                  value={age}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setExpectedDate(e.target.value.split("T")[0])
                  }
                />
              </div>
